...
namespace MSFT.RDMISaaS.API.BLL
{
    ...
    public class HostPoolBL
    {
       ...
       // string tenantGroup = Constants.tenantGroupName;
        ...
        /// <returns></returns>
        public RdMgmtHostPool GetHostPoolDetails(string tenantGroupName,string deploymentUrl, string accessToken, string tenantName, string hostPoolName)
        {
        ...
        /// <returns></returns>
        public List<RdMgmtHostPool> GetHostPoolList(string tenantGroupName,string deploymentUrl, string accessToken, string tenantName,bool isHostpoolNameOnly, bool isAll, int pageSize, string sortField, bool isDescending, int initialSkip, string lastEntry)
        {
            ...
            try
            {
                ...
                if (isAll == true)
                {
                    ...
                    response = CommonBL.InitializeHttpClient(deploymentUrl, accessToken).GetAsync("/RdsManagement/V1/TenantGroups/" + tenantGroupName + "/Tenants/" + tenantName + "/HostPools?SortField=" + sortField + "&IsDescending=" + isDescending + "&InitialSkip=" + initialSkip).Result;
